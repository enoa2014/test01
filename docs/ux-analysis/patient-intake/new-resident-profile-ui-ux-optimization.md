...
基于 [pages/patient-intake/wizard/wizard.wxml](../../../wx-project/pages/patient-intake/wizard/wizard.wxml) 的五步骤向导：
...
以下多联系人管理方案为历史设计，保留于文档以供参考，不再作为现网实现：
...
| 文件路径 | 修改内容 |
|---------|---------|
| `wx-project/pages/patient-intake/wizard/wizard.js` | 身份证解析、多联系人管理、步骤调整 |
| `../wx-project/pages/patient-intake/wizard/wizard.wxml` | 字段锁定UI、联系人列表视图 |
| `wx-project/pages/patient-intake/wizard/wizard.wxss` | 新增样式（锁定字段、联系人卡片） |
