...
let ListServiceTcbr = class ListServiceTcbr extends common_1.Command {
    ...
    execute(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            loading.stop()
            const specificServer = serverList.filter(
                (serverItem) => serverItem.ServerName === serviceName
            )
            if (options.json) {
                console.log(
                    JSON.stringify(
                        {
                            code: 0,
                            errmsg: 'success',
                            data: specificServer.length ? specificServer : serverList
                        },
                        null,
                        2
                    )
...
__decorate(
    ...
    ListServiceTcbr.prototype,
    'execute',
    null
)
ListServiceTcbr = __decorate([(0, common_1.ICommand)()], ListServiceTcbr)
