...
const modifyByFlow = (envId, serviceName, mode) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (res !== 'succ') throw new error_1.CloudBaseError('分配失败')
        loading.succeed('分配成功')
    })
const modifyByURL = (envId, serviceName, mode) =>
    __awaiter(void 0, void 0, void 0, function* () {
        const versionFlowItems = []
        const loading = (0, utils_1.loadingFactory)()
        mode.split('|')[1]
        ...
        if (!versionFlowItems.some((item) => item.VersionName === mode.split('|')[2])) {
            ...
            versionFlowItems.find(
                (item) => item.VersionName === mode.split('|')[2]
            ).IsDefaultPriority = true
        }
        loading.start('数据加载中...')
        const res = yield (0, run_1.modifyVersion)({
...
let ModifyVersion = class ModifyVersion extends common_1.Command {
    get options() {
        return Object.assign(Object.assign({}, (0, common_2.versionCommonOptions)('modify')), {
            options: [
                {
                    flags: '-e, --envId <envId>',
                    desc: '环境 Id'
    ...
    execute(envId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (serviceName.length === 0) throw new error_1.CloudBaseError('请填入有效云托管服务名')
...
__decorate(
    ...
    ModifyVersion.prototype,
    'execute',
    null
)
ModifyVersion = __decorate([(0, common_1.ICommand)()], ModifyVersion)
