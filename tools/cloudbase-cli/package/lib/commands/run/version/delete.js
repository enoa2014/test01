...
let DeleteVersion = class DeleteVersion extends common_1.Command {
    get options() {
        return Object.assign(Object.assign({}, (0, common_2.versionCommonOptions)('delete')), {
            options: [
                {
                    flags: '-e, --envId <envId>',
                    desc: '环境 Id'
...
__decorate(
    ...
    DeleteVersion.prototype,
    'execute',
    null
)
DeleteVersion = __decorate([(0, common_1.ICommand)()], DeleteVersion)
