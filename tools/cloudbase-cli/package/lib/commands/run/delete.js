...
let DeleteRun = class DeleteRun extends common_1.Command {
    ...
    execute(envId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            loading.start('数据加载中...')
            const versions = yield (0, run_1.listVersion)({
                envId,
            ...
            if (res === 'succ') loading.succeed('服务删除完成')
            else throw new error_1.CloudBaseError('服务删除失败')
            if (
...
DeleteRun = __decorate([(0, common_1.ICommand)()], DeleteRun)
