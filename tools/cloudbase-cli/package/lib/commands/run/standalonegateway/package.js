...
let PackageStandalonegateway = class PackageStandalonegateway extends common_1.Command {
    get options() {
        return Object.assign(
            Object.assign({}, (0, common_2.standalonegatewayCommonOptions)('package <operation>')),
            {
                options: [
                    {
                        flags: '-e, --envId <envId>',
...
__decorate(
    ...
    PackageStandalonegateway.prototype,
    'execute',
    null
)
PackageStandalonegateway = __decorate([(0, common_1.ICommand)()], PackageStandalonegateway)
