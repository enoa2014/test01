...
let CreateStandalonegateway = class CreateStandalonegateway extends common_1.Command {
    get options() {
        return Object.assign(
            Object.assign({}, (0, common_2.standalonegatewayCommonOptions)('create')),
            {
                options: [
                    {
                        flags: '-e, --envId <envId>',
...
__decorate(
    ...
    CreateStandalonegateway.prototype,
    'execute',
    null
)
CreateStandalonegateway = __decorate([(0, common_1.ICommand)()], CreateStandalonegateway)
