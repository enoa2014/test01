...
let TurnStandalonegateway = class TurnStandalonegateway extends common_1.Command {
    get options() {
        return Object.assign(
            Object.assign({}, (0, common_2.standalonegatewayCommonOptions)('turn <status>')),
            {
                options: [
                    {
                        flags: '-e, --envId <envId>',
    ...
    execute(envId, params, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            loading.start('数据加载中...')
            yield (
                status === 'on' ? run_1.turnOnStandalonegateway : run_1.turnOffStandalonegateway
            )({
                envId,
                gatewayName,
                serviceList
...
__decorate(
    ...
    TurnStandalonegateway.prototype,
    'execute',
    null
)
TurnStandalonegateway = __decorate([(0, common_1.ICommand)()], TurnStandalonegateway)
