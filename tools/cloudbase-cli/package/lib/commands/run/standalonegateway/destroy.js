...
let DestroyStandalonegateway = class DestroyStandalonegateway extends common_1.Command {
    get options() {
        return Object.assign(
            Object.assign({}, (0, common_2.standalonegatewayCommonOptions)('destroy')),
            {
                options: [
                    {
                        flags: '-e, --envId <envId>',
...
__decorate(
    ...
    DestroyStandalonegateway.prototype,
    'execute',
    null
)
DestroyStandalonegateway = __decorate([(0, common_1.ICommand)()], DestroyStandalonegateway)
