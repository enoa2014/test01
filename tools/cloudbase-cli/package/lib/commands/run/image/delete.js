...
let DeleteImage = class DeleteImage extends common_1.Command {
    get options() {
        return Object.assign(Object.assign({}, (0, common_2.imageCommonOptions)('delete')), {
            options: [
                {
                    flags: '-e, --envId <envId>',
                    desc: '环境 Id'
    ...
    execute(envId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const res = yield (0, run_1.deleteImage)({
                    envId,
                    imageUrl: imageUrl
                })
                if (res === 'success')
                    loading.succeed(`成功删除 ${serviceName} 服务下的 ${imageUrl} 镜像`)
                else throw new error_1.CloudBaseError('删除失败')
            } catch (e) {
...
__decorate(
    ...
    DeleteImage.prototype,
    'execute',
    null
)
DeleteImage = __decorate([(0, common_1.ICommand)()], DeleteImage)
