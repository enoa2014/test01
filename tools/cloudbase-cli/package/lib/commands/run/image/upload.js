...
let UploadImage = class UploadImage extends common_1.Command {
    get options() {
        return Object.assign(Object.assign({}, (0, common_2.imageCommonOptions)('upload')), {
            options: [
                {
                    flags: '-e, --envId <envId>',
                    desc: '环境 Id'
    ...
    execute(envId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield util.promisify(child_process_1.exec)(
                `docker tag ${imageId} ccr.ccs.tencentyun.com/${imageRepo}:${imageTag}`
            )
            let sh = new Promise((resolve, reject) => {
                ;(0, child_process_1.exec)(
                    `docker push ccr.ccs.tencentyun.com/${imageRepo}:${imageTag}`,
                    (stderr, stdout) =>
                        stderr ? reject(stderr) : resolve({ code: 0, info: stdout })
...
UploadImage = __decorate([(0, common_1.ICommand)()], UploadImage)
