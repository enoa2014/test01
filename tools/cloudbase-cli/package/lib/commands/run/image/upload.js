...
let UploadImage = class UploadImage extends common_1.Command {
    get options() {
        return Object.assign(Object.assign({}, (0, common_2.imageCommonOptions)('upload')), { options: [
                {
                    flags: '-e, --envId <envId>',
                    desc: '环境 Id'
                },
    ...
    execute(envId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield util.promisify(child_process_1.exec)(`docker tag ${imageId} ccr.ccs.tencentyun.com/${imageRepo}:${imageTag}`);
