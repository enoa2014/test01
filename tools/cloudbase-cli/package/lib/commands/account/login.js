...
let LoginCommand = class LoginCommand extends common_1.Command {
    ...
    execute(options, log) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                if (res.code === 'SUCCESS') {
                    ...
                    console.log(
                        chalk_1.default.gray(
                            '详细说明请参考：https://docs.cloudbase.net/cli-v1/login#%E8%85%BE%E8%AE%AF%E4%BA%91-%E4%BA%91%E5%BC%80%E5%8F%91%E6%8E%A7%E5%88%B6%E5%8F%B0%E6%8E%88%E6%9D%83'
                        )
                    )
                    console.log('')
            ...
            const consoleUrl =
                'https://console.cloud.tencent.com/tcb/env/index?action=CreateEnv&from=cli'
            try {
                const envs = yield (0, env_1.listEnvs)()
                if (!envs.length) {
                    log.warn(
                        `您还没有可用的环境，请前往控制台 ${(0, utils_1.genClickableLink)(consoleUrl)} 创建环境`
                    )
                }
            } catch (e) {
...
LoginCommand = __decorate([(0, common_1.ICommand)()], LoginCommand)
