        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (templateUri && isGitUrl(templateUri)) {
                if (clone) {
                    ...
                    yield (0, execa_1.default)(
                        'git',
                        ['clone', '--depth', 1, templateUri, appName],
                        {
                            stdio: 'inherit'
                        }
                    )
                    yield (0, utils_1.delSync)([
                        path_1.default.join(process.cwd(), appName, '.git')
                    ])
                }
...
NewCommand = __decorate([(0, common_1.ICommand)()], NewCommand)
