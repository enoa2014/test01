...
let OpenLinkCommand = class OpenLinkCommand extends common_1.Command {
    get options() {
        return {
            cmd: 'open [link]',
            options: [],
...
__decorate(
    ...
    OpenLinkCommand.prototype,
    'execute',
    null
)
OpenLinkCommand = __decorate([(0, common_1.ICommand)()], OpenLinkCommand)
