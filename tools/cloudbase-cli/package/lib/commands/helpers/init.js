...
const getTemplateAddress = (templatePath) =>
...
let InitCommand = class InitCommand extends common_1.Command {
    ...
    execute(options, log) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (env === CREATE_ENV) {
                ...
                const { envId } = yield (0, toolbox_1.getDataFromWeb)(
            ...
            if (!options.withoutTemplate) {
                const templates = yield (0, utils_1.execWithLoading)(
                    () => (0, utils_1.fetch)(listUrl),
                    {
                        startTip: '拉取云开发模板列表中'
                    }
                )
                ...
                yield (0, utils_1.execWithLoading)(
                    () =>
                        __awaiter(this, void 0, void 0, function* () {
                            yield (0, utils_1.templateDownloadReport)(
                                selectedTemplate.path,
                                selectedTemplate.name
                            )
                            yield this.extractTemplate(
                                projectPath,
                                selectedTemplate.path,
            ...
            let filepath =
                (_a = yield (0, toolbox_1.searchConfig)(projectPath)) === null || _a === void 0
                    ? void 0
                    : _a.filepath
            if (!filepath) {
                fs_1.default.writeFileSync(
                    path_1.default.join(projectPath, 'cloudbaserc.json'),
                    JSON.stringify({
                        envId: env,
                        version: '2.0',
    ...
    checkLogin(log) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (lodash_1.default.isEmpty(credential)) {
                ...
                const envId =
                    (_a = res === null || res === void 0 ? void 0 : res.credential) === null ||
                    _a === void 0
                        ? void 0
                        : _a.envId
                if (envId) {
    ...
    extractTemplate(projectPath, templatePath, remoteUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, utils_1.fetchStream)(url).then((res) =>
                __awaiter(this, void 0, void 0, function* () {
                    if (!res) {
    ...
    initSuccessOutput(projectName, log) {
        ...
        log.info(
            `👉 开发完成后，执行命令 ${chalk_1.default.bold.cyan('cloudbase framework:deploy')} 一键部署`
        )
    }
}
__decorate(
...
InitCommand = __decorate([(0, common_1.ICommand)()], InitCommand)
