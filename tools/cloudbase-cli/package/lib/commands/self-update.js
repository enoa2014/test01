...
let SelfUpdateCommand = class SelfUpdateCommand extends common_1.Command {
    get options() {
        return {
            ...
            options: [
                ...
                {
                    flags: '--download-base <url>',
                    desc: '下载基址，默认 https://static.cloudbase.net/cli'
                }
            ]
        }
    }
    execute(ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const base =
                ctx.options.downloadBase ||
                process.env.DOWNLOAD_BASE ||
                'https://static.cloudbase.net/cli'
            ...
            try {
                ...
                throw new error_1.CloudBaseError(
                    `自更新失败：${(e === null || e === void 0 ? void 0 : e.message) || e}`
                )
            }
        })
    }
}
SelfUpdateCommand = __decorate([(0, common_1.ICommand)()], SelfUpdateCommand)
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const entries = fs_1.default
                ...
                .filter(
                    (n) =>
                        !n.startsWith('.') &&
                        fs_1.default.statSync(path_1.default.join(versionsDir, n)).isDirectory()
                )
                .sort()
            if (entries.length < 2) {
            ...
            try {
                ...
                throw new error_1.CloudBaseError(
                    `回滚失败：${(e === null || e === void 0 ? void 0 : e.message) || e}`
                )
            }
        })
    }
}
RollbackCommand = __decorate([(0, common_1.ICommand)()], RollbackCommand)
