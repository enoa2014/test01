...
let InvokeFunction = class InvokeFunction extends common_1.Command {
    ...
    execute(ctx, argsParams, log) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const configParams = (func === null || func === void 0 ? void 0 : func.params)
                ? func.params
                : undefined
            ...
            const formatInfo = Object.assign(Object.assign({}, result), {
...
__decorate(
    ...
    InvokeFunction.prototype,
    'execute',
    null
)
InvokeFunction = __decorate([(0, common_1.ICommand)()], InvokeFunction)
