...
let AttachFileLayer = class AttachFileLayer extends common_1.Command {
    get options() {
        return Object.assign(Object.assign({}, (0, common_2.layerCommonOptions)('bind <name>')), {
...
__decorate(
    ...
    AttachFileLayer.prototype,
    'execute',
    null
)
AttachFileLayer = __decorate([(0, common_1.ICommand)()], AttachFileLayer)
exports.AttachFileLayer = AttachFileLayer
let UnAttachFileLayer = class UnAttachFileLayer extends common_1.Command {
    get options() {
        return Object.assign(Object.assign({}, (0, common_2.layerCommonOptions)('unbind <name>')), {
    ...
    execute(envId, params, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (
                !((_a = detail === null || detail === void 0 ? void 0 : detail.Layers) === null ||
                _a === void 0
                    ? void 0
                    : _a.length)
            ) {
...
__decorate(
    ...
    UnAttachFileLayer.prototype,
    'execute',
    null
)
UnAttachFileLayer = __decorate([(0, common_1.ICommand)()], UnAttachFileLayer)
