...
let SortFileLayer = class SortFileLayer extends common_1.Command {
    get options() {
        return Object.assign(Object.assign({}, (0, common_2.layerCommonOptions)('sort <name>')), {
    ...
    execute(ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            sortLayers = sortLayers.map((item) =>
                lodash_1.default.pick(item, ['LayerName', 'LayerVersion'])
            )
...
__decorate(
    ...
    SortFileLayer.prototype,
    'execute',
    null
)
SortFileLayer = __decorate([(0, common_1.ICommand)()], SortFileLayer)
