...
let ListFileLayer = class ListFileLayer extends common_1.Command {
    get options() {
        return Object.assign(Object.assign({}, (0, common_2.layerCommonOptions)('list')), {
...
__decorate(
    ...
    ListFileLayer.prototype,
    'execute',
    null
)
ListFileLayer = __decorate([(0, common_1.ICommand)()], ListFileLayer)
