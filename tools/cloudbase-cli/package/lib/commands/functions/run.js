...
exports.FunctionDebug = exports.debugByConfig = exports.debugFunctionByPath = void 0
...
function spawnNodeProcess(args, options) {
    ...
    const exec = (0, child_process_1.spawn)(
        'node',
        args,
        Object.assign(Object.assign({}, commonOptions), options)
    )
    exec.on('error', (e) => {
...
function debugByConfig(ctx, name) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const handlers = (
            (funcConfig === null || funcConfig === void 0 ? void 0 : funcConfig.handler) ||
            'index.main'
        ).split('.')
        ...
        try {
            ...
            const requirePath =
                process.platform === 'win32' ? finalPath.replace(/\\/g, '\\\\') : finalPath
        ...
        spawnNodeProcess(args, {
            env: Object.assign(
                Object.assign(
                    Object.assign(Object.assign({}, process.env), {
                        SCF_NAMESPACE: envId,
                        SCF_FUNCTION_HANDLER:
                            (funcConfig === null || funcConfig === void 0
                                ? void 0
                                : funcConfig.handler) || 'index.main',
                        SCF_FUNCTION_NAME:
                            (funcConfig === null || funcConfig === void 0
                                ? void 0
                                : funcConfig.name) || 'main',
                        GLOBAL_USER_FILE_PATH: path_1.default.join(
                            debugDirname,
                            path_1.default.sep
                        ),
                        SCF_EVENT_BODY:
...
__decorate(
    ...
    FunctionDebug.prototype,
    'execute',
    null
)
FunctionDebug = __decorate([(0, common_1.ICommand)()], FunctionDebug)
