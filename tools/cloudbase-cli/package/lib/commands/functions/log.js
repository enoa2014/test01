...
let FunctionLog = class FunctionLog extends common_1.Command {
    ...
    execute(ctx, argsParams, log) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const logs = yield functionService.getCompleteFunctionLogs(
...
__decorate(
    ...
    FunctionLog.prototype,
    'execute',
    null
)
FunctionLog = __decorate([(0, common_1.ICommand)()], FunctionLog)
