...
exports.CloudFunctionRunCommand =
    exports.CloudFunctionDownloadCommand =
    exports.CloudFunctionDeployCommand =
        void 0
                    ...
                    try {
                        ...
                        if (
                            ...
                            _a === void 0
                                ? void 0
                                : _a.includes(
                                      '当前函数处于Updating状态，无法进行此操作，请稍后重试'
                                  ))
                        ) {
...
__decorate(
    ...
    CloudFunctionDeployCommand.prototype,
    'execute',
    null
)
CloudFunctionDeployCommand = __decorate([(0, common_1.ICommand)()], CloudFunctionDeployCommand)
...
__decorate(
    ...
    CloudFunctionDownloadCommand.prototype,
    'execute',
    null
)
CloudFunctionDownloadCommand = __decorate([(0, common_1.ICommand)()], CloudFunctionDownloadCommand)
...
__decorate(
    ...
    CloudFunctionRunCommand.prototype,
    'execute',
    null
)
CloudFunctionRunCommand = __decorate([(0, common_1.ICommand)()], CloudFunctionRunCommand)
