...
exports.UnbindCustomDomainCommand =
    exports.GetCustomDomainsCommand =
    exports.BindCustomDomainCommand =
        void 0
...
__decorate(
    ...
    BindCustomDomainCommand.prototype,
    'execute',
    null
)
    ...
    execute(envId, options, log) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (
                    !((_a = res === null || res === void 0 ? void 0 : res.ServiceSet) === null ||
                    _a === void 0
                        ? void 0
                        : _a.length)
                ) {
...
__decorate(
    ...
    GetCustomDomainsCommand.prototype,
    'execute',
    null
)
GetCustomDomainsCommand = __decorate([(0, common_1.ICommand)()], GetCustomDomainsCommand)
...
__decorate(
    ...
    UnbindCustomDomainCommand.prototype,
    'execute',
    null
)
UnbindCustomDomainCommand = __decorate([(0, common_1.ICommand)()], UnbindCustomDomainCommand)
