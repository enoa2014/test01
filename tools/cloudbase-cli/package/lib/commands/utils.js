...
exports.getCloudbaserc =
    exports.upsertCloudbaserc =
    exports.rawFetchAccessToken =
    exports.fetchAccessToken =
    exports.getCredential =
    exports.trackCallback =
    exports.isDirectoryEmptyOrNotExists =
    exports.getPackageJsonName =
    exports.selectEnv =
        void 0
...
function rawFetchAccessToken(params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tokenResponse = yield (0, node_fetch_1.default)(url, {
            method,
            headers: Object.assign(Object.assign({}, requiredHeaders), {
...
function upsertCloudbaserc(projectPath, inputData) {
    return __awaiter(this, void 0, void 0, function* () {
        const { envId } = inputData,
            rest = __rest(inputData, ['envId'])
        ...
        try {
            ...
            throw new Error(
                `更新 cloudbaserc.json 失败: ${error instanceof Error ? error.message : String(error)}`
            )
        }
    })
}
...
function getCloudbaserc(projectPath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return yield (0, utils_1.getCloudBaseConfig)(
                path_1.default.resolve(projectPath, 'cloudbaserc.json')
            )
        } catch (e) {
            return {}
        }
