    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (serviceDetail === undefined) {
            throw new toolbox_1.CloudBaseError(
                `当前服务不存在，请前往控制台 ${(0, utils_1.genClickableLink)('https://console.cloud.tencent.com/tcbr')} 创建服务`
            )
        }
        ...
        const previousServerConfig =
            serviceDetail === null || serviceDetail === void 0 ? void 0 : serviceDetail.ServerConfig
        const newServiceOptions = yield (0, common_1.tcbrServiceOptions)(
            options,
            true,
            true,
