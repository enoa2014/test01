...
exports.CmdContext = (0, common_1.createParamDecorator)(
    constants_1.ParamTypes.CmdContext,
    EmptyValue
)
exports.ArgsOptions = (0, common_1.createParamDecorator)(
    constants_1.ParamTypes.ArgsOptions,
    EmptyValue
)
exports.ArgsParams = (0, common_1.createParamDecorator)(
    constants_1.ParamTypes.ArgsParams,
    EmptyValue
)
...
exports.IsPrivateEnv = (0, common_1.createParamDecorator)(
    constants_1.ParamTypes.IsPrivateEnv,
    EmptyValue
)
