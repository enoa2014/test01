...
class AISetupWizard {
    ...
    setUpDefault(log, agent) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const defaultAgent =
                    agent || (yield this.selectAgent('选择默认使用的 AI CLI 工具:', false))
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (_envId) {
                ...
                if (!configEnvId || configEnvId === '{{env.ENV_ID}}') {
                    ...
                    const { authSupevisor } = yield Promise.resolve().then(() =>
                        __importStar(require('../../utils/auth'))
                    )
                    ...
                    envId = yield (0, utils_1.selectEnv)({
    ...
    selectDefaultAgent(log) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const configuredAgents = (config === null || config === void 0 ? void 0 : config.agents)
            ...
            if (configuredAgents.length === 1) {
                ...
                const agentInfo = [
                    ...
                    const_1.CURSOR,
                    const_1.AIDER
                ].find((a) => a.value === selectedAgent)
                const agentName =
                    (agentInfo === null || agentInfo === void 0 ? void 0 : agentInfo.name) ||
    ...
    configureClaudeAgent(log) {
        return __awaiter(this, void 0, void 0, function* () {
            log.info(
                `配置说明可参考 ${(0, output_1.genClickableLink)('https://docs.cloudbase.net/cli-v1/ai/claude')}`
            )
            const { configMethod } = yield inquirer_1.default.prompt([
                {
                    ...
                    choices: [
                        ...
                        {
                            name: '暂不配置，使用 Claude Code 内置鉴权方式（如 OAuth）',
                            value: 'none'
                        }
                    ],
                    default: 'cloudbase'
            ...
            if (configMethod === 'cloudbase') {
                ...
                yield this.aiConfigManager.updateClaudeConfig(
                    'cloudbase',
                    Object.assign({ provider, model }, transformer && { transformer })
                )
    ...
    configureQwenAgent(log) {
        return __awaiter(this, void 0, void 0, function* () {
            log.info(
                `配置说明可参考 ${(0, output_1.genClickableLink)('https://docs.cloudbase.net/cli-v1/ai/qwen')}`
            )
            const { configMethod } = yield inquirer_1.default.prompt([
                {
                    type: 'list',
    ...
    configureCodexAgent(log) {
        return __awaiter(this, void 0, void 0, function* () {
            log.info(
                `配置说明可参考 ${(0, output_1.genClickableLink)('https://docs.cloudbase.net/cli-v1/ai/codex')}`
            )
            const { configMethod } = yield inquirer_1.default.prompt([
                {
                    type: 'list',
                    ...
                    choices: [
                        ...
                        { name: '自配置 API KEY 和 Base URL', value: 'custom' },
                        {
                            name: '暂不配置，使用 OpenAI Codex 内置鉴权方式（如 OAuth）',
                            value: 'none'
                        }
                    ],
                    default: 'cloudbase'
    ...
    configureAiderAgent(log) {
        return __awaiter(this, void 0, void 0, function* () {
            log.info(
                `配置说明可参考 ${(0, output_1.genClickableLink)('https://docs.cloudbase.net/cli-v1/ai/aider')}`
            )
            const { configMethod } = yield inquirer_1.default.prompt([
                {
                    type: 'list',
    ...
    configureCursorAgent(log) {
        return __awaiter(this, void 0, void 0, function* () {
            log.info(
                `配置说明可参考 ${(0, output_1.genClickableLink)('https://docs.cloudbase.net/cli-v1/ai/cursor')}`
            )
    ...
    selectCloudBaseProvider() {
        return __awaiter(this, void 0, void 0, function* () {
            const { selectedProvider } = yield inquirer_1.default.prompt([
                {
                    ...
                    choices: const_1.CLOUDBASE_PROVIDERS.map((p) => ({
                        name: p.name,
                        value: p.value
                    })),
                    default: 'kimi-exp'
            ...
            if (selectedProvider === 'custom') {
                ...
                const selectedConfig = const_1.CLOUDBASE_PROVIDERS.find(
                    (p) => p.value === selectedProvider
                )
                const modelChoices = [...selectedConfig.models.map((m) => ({ name: m, value: m }))]
    ...
    configureCodebuddyAgent(log) {
        return __awaiter(this, void 0, void 0, function* () {
            log.info(
                `配置说明可参考 ${(0, output_1.genClickableLink)('https://cnb.woa.com/genie/genie/-/tree/main/docs')}`
            )
            const { configMethod } = yield inquirer_1.default.prompt([
                {
                    type: 'list',
