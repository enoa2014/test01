...
exports.LIST_HINT =
    exports.getBooleanHint =
    exports.getDefaultModelByBaseUrl =
    exports.BASE_URL_MODEL_MAPPING =
    exports.getAgentConfigValidator =
    ...
    exports.CLOUDBASE_MCP_CONFIG_PATH =
    exports.CLAUDE_CODE_ROUTER_LOGS_DIR_PATH =
    exports.CLAUDE_CODE_ROUTER_LOG_PATH =
    exports.CLAUDE_CODE_ROUTER_CONFIG_PATH =
    exports.ENV_LOCAL_PATH =
    exports.CONFIG_PATH =
        void 0
...
exports.CLAUDE_CODE_ROUTER_CONFIG_PATH = path_1.default.join(
    os_1.default.homedir(),
    '.claude-code-router',
    'config.json'
)
exports.CLAUDE_CODE_ROUTER_LOG_PATH = path_1.default.join(
    os_1.default.homedir(),
    '.claude-code-router',
    'claude-code-router.log'
)
exports.CLAUDE_CODE_ROUTER_LOGS_DIR_PATH = path_1.default.join(
    os_1.default.homedir(),
    '.claude-code-router',
    'logs'
)
