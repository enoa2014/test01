...
exports.FunctionPacker = exports.CodeType = void 0;
...
class FunctionPacker {
    ...
    getJavaFileCode() {
        const { funcPath } = this;
        const jarExist = (0, toolbox_1.checkFullAccess)(`${funcPath}.jar`);
        const zipExist = (0, toolbox_1.checkFullAccess)(`${funcPath}.zip`);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (type === CodeType.JavaFile) {
                try {
                    ...
                    this.clean();
                    throw new toolbox_1.CloudBaseError(`函数代码打包失败：\n ${error.message}`);
                }
            }
