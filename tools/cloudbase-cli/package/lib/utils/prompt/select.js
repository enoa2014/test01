    ...
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        while (true) {
            const thisRoundList =
                nextRoundList ||
                (yield listFetcher(
                    Object.assign(Object.assign({}, options), { limit: 10, offset: offset })
                ))
                    .filter(filter)
                    .map(mapper)
            offset += 10
            nextRoundList = (yield listFetcher(
                Object.assign(Object.assign({}, options), { limit: 10, offset: offset })
            ))
                .filter(filter)
                .map(mapper)
            ...
            if (type === 'select') {
                let receiver = (yield (0, enquirer_1.prompt)({
                    ...
                    message: message,
                    choices: (
                        nextRoundList === null || nextRoundList === void 0
                            ? void 0
                            : nextRoundList.length
                    )
                        ? [...thisRoundList, '下一页']
                        : [...thisRoundList]
                })).receiver
