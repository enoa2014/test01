...
class CloudApiService {
    static getInstance(service) {
        var _a
        if (
            (_a = CloudApiService.serviceCacheMap) === null || _a === void 0 ? void 0 : _a[service]
        ) {
        ...
        this.apiService = new cloud_api_1.CloudApiService({
            ...
            getCredential: () =>
                __awaiter(this, void 0, void 0, function* () {
                    if (
                        (commonCredential === null || commonCredential === void 0
                            ? void 0
                            : commonCredential.secretId) &&
                        !isTokenExpired(commonCredential)
                    ) {
                    ...
                    return Object.assign(Object.assign({}, credential), {
