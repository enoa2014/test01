...
const CONTACT_FIELD_CONFIG = [
  ...
  { key: 'emergencyContact', label: '紧急联系人', type: 'text', required: true, maxLength: 30 },
  { key: 'emergencyPhone', label: '紧急联系人电话', type: 'text', required: true, keyboard: 'number', maxLength: 11 },
...
const INTAKE_FIELD_CONFIG = [
  ...
  { key: 'narrative', label: '情况说明', type: 'textarea', required: true, minLength: 30, maxLength: 500, autoHeight: true },
